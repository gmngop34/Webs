const allMovies = [
    {
        ...
        category: "featured",
        quality: "BluRay",
        image: "https://m.media-amazon.com/images/I/91kFYSeSaML._AC_SL1500_.jpg",
...
function filterByCategory(categoryName) {
    ...
    setTimeout(() => {
        if (!window.location.pathname.includes('movies.html') && !window.location.pathname.includes('index.html')) {
        ...
        toggleLoader(false); // HIDE SPINNER after filtering is done
    }, 400); 
}
